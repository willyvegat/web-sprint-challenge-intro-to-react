...
- React JS is a User Interface Component library. It was created to solve problems the team of Facebook was facing when dealing with complex state. It was desgined to build user interfaces.

2. Describe component state.
- It is data that lives in the state. The useState has an array of two which include a state variable and a function to update the state variable
